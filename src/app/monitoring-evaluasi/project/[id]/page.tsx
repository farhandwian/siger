    ...
    <div className="flex flex-col gap-0.5 lg:gap-1">
      ...
      <div className="relative">
        <input
          ...
          className="w-full bg-white border-b border-gray-200 px-2 py-1 lg:px-2.5 lg:py-1.5 xl:px-3 xl:py-2 text-[9px] text-gray-700 lg:text-[10px] xl:text-xs focus:border-blue-500 focus:outline-none"
        />
        {isLoading && (
      ...
      <div className="min-w-0 flex-1 lg:ml-0">
        ...
        <main className="p-2 lg:p-3 xl:p-6">
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm lg:p-5 xl:p-8">
            ...
            <div className="pt-3 lg:pt-4 xl:pt-6 space-y-4 lg:space-y-5 xl:space-y-6">
