...
export const SpinnerIcon: React.FC<{ className?: string }> = ({ className = 'w-4 h-4' }) => (
...
export const PackageIcon: React.FC<{ className?: string }> = ({ className = 'w-4 h-4' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Add missing icons for Analisa Kebutuhan
